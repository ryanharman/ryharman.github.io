...
- Xploro, Provided architectural support for large scale refactoring of the API. Led incremental TypeScript adoption, update of components to use Radix UI, Tailwind, and React Query across the portal.
